...
<p class="submit"><a href="<?php echo esc_url( wp_nonce_url( add_query_arg( 'do_update_the7', 'true', admin_url( 'admin.php?page=the7-dashboard' ) ), 'do_update_the7_nonce' ) ); ?>" class="the7-update-now button-primary"><?php _e( 'Run the updater', 'the7mk2' ); ?></a></p>
